...
```bibtex
@article{mazraedoost2025prediction,
  title={Prediction of Chromatographic Retention Time of a Small Molecule from SMILES Representation Using a Hybrid Transformer-LSTM Model},
  author={Mazraedoost, Sargol and Sedigh Malekroodi, Hadi and Žuvela, Petar and Yi, Myunggi and Liu, J Jay},
